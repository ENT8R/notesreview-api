...
async def status(request):
    ...
    with (
        open(os.path.join(directory, 'scripts', 'LAST_IMPORT.txt')) as file1,
        open(os.path.join(directory, 'scripts', 'LAST_SYNC.txt')) as file2,
        open(os.path.join(directory, 'scripts', 'LAST_UPDATE.txt')) as file3,
    ):
